...
function HomeJsonLd() {
  const organizationSchema = {
    ...
    founder: {
      ...
      knowsAbout: ["jumbo cookie wall art", "sugar cookie art", "faux food sculpture", "art cookies wall sculpture"],
    },
    address: {
      "@type": "PostalAddress",
  ...
  const websiteSchema = {
    ...
    name: site.name,
    url: siteUrl,
    description: "Jumbo cookie wall art and sugar cookie wall sculptures by cookie artist Erynn. Handmade art cookies wall sculpture pieces and faux food wall art.",
    publisher: {
      "@type": "Organization",
      name: site.name,
    },
